...
Stop _stop(String order, String outlet, String name, String district, int ws, int we, int eta, bool chilled, List<Item> items, double x, double y, {bool mall = false}) => Stop(
      orderId: order,
      outletId: outlet,
      outletName: name,
      district: district,
...
List<Trip> seedTrips() => [
      Trip(id: 'TRP-014-1', vehicleId: 'VEH014', vehicleType: 'Reefer truck', driver: 'Nimal', number: 1, brand: 'Fresh', district: 'Colombo', departure: 225, stops: [
        _stop('ORD1429', 'OUT032', 'Fresh Borella', 'Colombo', 300, 450, 300, true, [Item('Milk', 'crates', 12), Item('Frozen goods', 'crates', 4), Item('Produce', 'crates', 8)], 0.52, 0.30),
        _stop('ORD1441', 'OUT047', 'Fresh Narahenpita', 'Colombo', 300, 420, 326, true, [Item('Milk', 'crates', 9), Item('Yoghurt', 'crates', 6), Item('Dry goods', 'cartons', 5)], 0.68, 0.48),
        _stop('ORD1417', 'OUT018', 'Fresh Bambalapitiya', 'Colombo', 300, 450, 353, true, [Item('Milk', 'crates', 14), Item('Produce', 'crates', 7)], 0.30, 0.58),
        _stop('ORD1404', 'OUT004', 'Fresh Kollupitiya', 'Colombo', 300, 450, 380, true, [Item('Milk', 'crates', 8), Item('Yoghurt', 'crates', 13), Item('Frozen goods', 'crates', 5), Item('Produce', 'crates', 6)], 0.18, 0.40),
        _stop('ORD1449', 'OUT056', 'Fresh Kirulapone', 'Colombo', 300, 480, 414, true, [Item('Milk', 'crates', 15), Item('Yoghurt', 'crates', 6), Item('Frozen goods', 'crates', 4), Item('Produce', 'crates', 11), Item('Dry goods', 'cartons', 4)], 0.56, 0.80),
      ]),
      Trip(id: 'TRP-021-1', vehicleId: 'VEH021', vehicleType: 'Reefer van', driver: 'Kasun', number: 1, brand: 'Fresh', district: 'Gampaha', departure: 225, stops: [
        _stop('ORD1455', 'OUT061', 'Fresh Ja-Ela', 'Gampaha', 300, 450, 305, true, [Item('Milk', 'crates', 10), Item('Produce', 'crates', 6)], 0.4, 0.3),
        _stop('ORD1460', 'OUT066', 'Fresh Wattala', 'Gampaha', 270, 420, 334, false, [Item('Produce', 'crates', 9), Item('Dry goods', 'cartons', 7)], 0.6, 0.6),
        _stop('ORD1463', 'OUT070', 'Fresh Kadawatha', 'Gampaha', 300, 480, 371, true, [Item('Milk', 'crates', 11), Item('Yoghurt', 'crates', 4)], 0.3, 0.7),
      ]),
      Trip(id: 'TRP-008-2', vehicleId: 'VEH008', vehicleType: 'Truck', driver: 'Dilan', number: 2, brand: 'Style', district: 'Colombo', departure: 510, stops: [
        _stop('ORD1471', 'OUT077', 'Style Havelock', 'Colombo', 600, 720, 612, false, [Item('Apparel', 'cartons', 18), Item('Footwear', 'cartons', 6)], 0.3, 0.3),
        _stop('ORD1474', 'OUT081', 'Style Majestic Mall', 'Colombo', 600, 660, 640, false, [Item('Apparel', 'cartons', 12)], 0.6, 0.5, mall: true),
      ]),
      Trip(id: 'TRP-033-2', vehicleId: 'VEH033', vehicleType: 'Van', driver: 'Ruwan', number: 2, brand: 'Tech', district: 'Kalutara', departure: 735, stops: [
        _stop('ORD1480', 'OUT091', 'Tech Panadura', 'Kalutara', 840, 1020, 846, false, [Item('Electronics', 'cartons', 8), Item('Accessories', 'boxes', 14)], 0.5, 0.4),
        _stop('ORD1484', 'OUT095', 'Tech Horana', 'Kalutara', 780, 960, 900, false, [Item('Electronics', 'cartons', 5)], 0.7, 0.7),
      ]),
    ];
...
class MockKaironApi implements KaironApi {
  static const _key = 'kairon.mock-server';
  final _rng = Random();
